  ...
  public void ensurePreconditions (){
    if (app.db().contacts().size() == 0 ){
      ...
      app.contact().create(new ContactData()
              .withFirstname("first").withLastname("last").withTitle("title").withAddress("address").withHomePhone("11144").withMobilePhone("23465").withWorkPhone("0000").withEmail1("abcde@gmail.com").withEmail2("abcde22@gmail.com").withEmail3("abcde33@gmail.com").inGroup(new GroupData().withName(selectGroup.getName())), true);
